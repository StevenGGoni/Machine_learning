# -*- coding: utf-8 -*-
"""
Created on Fri Dec 30 13:46:04 2022
...
clasificador = svm.SVC(kernel= "rbf", #gaussiano
                       random_state = 0) 
...
parametros = [{"C": [1, 2, 3, 10], "kernel": ["linear"]},
              {"C": [1, 2, 3, 10], "kernel": ["rbf"], "gamma": [0.9, 0.8, 0.3]},
              {"C": [1, 2, 3, 10], "kernel": ["sigmoid"]}]
...
resultados = grid_search.fit(x_train, y_train)
